...
w_dir = r'D:\Science\MMML\Image Processing\MHT-X\Data for Tracking'
os.chdir(w_dir)
...
Sig_displacement_movement   = 8 # sigma_pos; default = 8
Sig_acceleration            = 15 # simga_a; default = 15
Velocity_scaler             = 50 # lambda_dir; default = 50
Weight_movement1            = 0.7 # beta_1; default = 0.7
Weight_movement2            = 0.2 # beta_2; default = 0.2
...
A                   = 0.01 # a; default = 0.01
A_prime             = 0.001 # a'; default = 0.05; baseline entry/exit prob, flat value for the modified exit/entry function

# Shouln't really be tinkered with, this is fine
Boundary            = 7 # B, not in definition; default = 7
...
exitt   = exit_entry_func(A_prime, A, Boundary, 1, 0)
entry   = exit_entry_func(A_prime, -A, Width - Boundary, 0, 0)
...
Vel_thresh = 0 # if velocity lower than this, replace it with default; default = 0

# Legacy, kicks in only when thershold kicks in
Mu_Vel0 = 10  # default absolute velocity; default = 10

# Velocity sigma is legacy, nothing uses it, nvm this
Sig_mul = 10 # multiplyer for velocity variance; default = 10

# kicks in only when there are not enough points, is not multiplied by Sig_mul
Sig_Vel0 = 3 # default absolute velocity variance; default = 3
...
Smoother = 30 # a parameter for splines, a smoothing constant; default = 30
...
Max_occlusion = 2 # delta_t max; default = 2
Quantile = 0.5 # q; default = 0.5
#%%
...
string = '/search_'
tracer.dump_data(string, memory = 50, smallest_trajectories = 2)
import json
